...
public class CreditEntryPage extends JFrame {
	...
	private static final int INDEX_OF_CREDIT_TYPE =2;
	private static final int INDEX_OF_BIG_CRATE_DEPOSIT =3;
	private static final int INDEX_OF_CRATE_DEPOSIT =4;
	private static final int INDEX_OF_CASH_DEPOSIT =5;
	private static final int INDEX_OF_BILL_NUMBER =6;	
	private static final int INDEX_OF_DATA_COMMITTED =7;
	private static final int SIZE_OF_TABLE_COLUMN =8;
	...
	public CreditEntryPage (Frame homePage, String string, boolean b) {
		...
		rightTopInfoPanel.setBounds( 200, 10, 750, 165 );
		...
		rightPanel.setBounds( 200, 180, 750, 290 );
	...
	private void createCommitAllEntresButton() {
		...
		commitEntryButton.setBounds( 410, 260, 170, 20 );
	...
	private void initializeColumnHeaders () {
		...
		customerCreditColumns [INDEX_OF_CREDIT_TYPE] ="<html>Credit<br> Type";
		customerCreditColumns [INDEX_OF_DATE] ="<html>Entry<br> Date";
		customerCreditColumns [INDEX_OF_CRATE_DEPOSIT] ="<html>Small Crate<br> Reurned";
	...
	private void initializeColumnClass () {
		...
		columnClasses [ INDEX_OF_CREDIT_TYPE ] = String.class;    		 
	...
	private void populateCreditEntryTable() {
		...
		for (Object s : customerCreditEntryList) {
			...
			obj[INDEX_OF_CREDIT_TYPE] = credtEntry.getCreditType();	
		...
		creditEntryModel = new DefaultTableModel(){
			...
			public Class getColumnClass(int c) {
				return CreditEntryPage.this.columnClasses [c];
			}
		};
	...
	public static void main(String[] args) {
		try {
			...
			CreditEntryPage dialog = new CreditEntryPage (null, "aaa", false);
	...
	public void populateCustomerCreditEntryData(CreditEntry creditEntry) {
		...
		creditEntry.setCreditType ("Deposit");
