...
import nmfc.TruckSalePage.AddCustomerEntryActionListener;
import nmfc.TruckSalePage.GetTruckByDateActionListener;
import nmfc.TruckSalePage.GetUnsoldTruckActionListener;
...
public class TruckSalePage extends JFrame{
	...
	public TruckSalePage(Frame homePage, String string, boolean b) {
	//	super (homePage,  string,  b);
		...
		// It is not required as data will be modified on change
...
*/
	...
	public static void main(String[] args) {
		try {
			...
			TruckSalePage dialog = new TruckSalePage (null, "aaa", false);
	...
	public class AddTruckSaleActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			JDialog page=new UpdateTruckSaleEntry( TruckSalePage.this, "Truck Sale Datea Update", true, truckSale);
